      ...
      <div className="beauty-container relative z-20">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            ...
            <button className="px-6 py-3 rounded-full border border-beauty-700 text-beauty-700 font-medium transition-all duration-300 hover:bg-beauty-50 hover:shadow-sm w-full sm:w-auto">
              Learn More
            </button>
          </div>
        </div>
